...
void Application::InitializeGLFW() {
	...
	glfwSetMouseButtonCallback(m_glfwWindow, Application::OnMouseButton);
}
...
void Application::MouseButton(int button, int action, int mod)
{
...
{
	Application* application = reinterpret_cast<Application*>(glfwGetWindowUserPointer(window));
	application->MouseButton(button,  action, mod);
}
